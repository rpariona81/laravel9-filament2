...
<div class="h-screen pb-14 bg-right bg-cover" style="background-image:url('bg.svg');">
	...
	<div class="w-full container mx-auto p-6">
		...
		<div class="w-full flex items-center justify-between">
			<a class="flex items-center text-sky-400 no-underline hover:no-underline font-bold text-2xl lg:text-4xl"  href="#"> 
			...
			<div class="flex w-1/2 justify-end content-center">		
                ...
                @if (Route::has('login'))
                    @auth
                        <a href="{{ url('/dashboard') }}" class="inline-block font-black text-sky-900 no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4">Dashboard</a>
                    @else
                        <a href="{{ route('login') }}" class="inline-block font-black text-blue-900 no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4">Log in</a>

                        @if (Route::has('register'))
                            <a href="{{ route('register') }}" class="inline-block font-black text-cyan-900 no-underline hover:text-indigo-800 hover:text-underline text-center h-10 p-2 md:h-auto md:p-4">Register</a>
                        @endif
                    @endauth
